...
import { Search, Database, FileCode2, Smartphone, HardDrive, Archive, Download, FileText, Image as ImageIcon, Loader2, Upload } from "lucide-react";
        ...
        <div className="flex-1 mt-6">
          ...
          <TabsContent value="backups" className="m-0 h-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card className="border-white/10 glass-panel">
                <CardHeader><CardTitle className="text-base flex items-center"><Archive className="w-4 h-4 mr-2" /> BlackBerry Forensics</CardTitle></CardHeader>
                <CardContent className="flex flex-col gap-3 text-sm text-muted-foreground">
                  <p>BlackBerry backup formats (.bbb, .ipd, .rem, .cod, .dat, .key, .mkf) are automatically identified when uploaded.</p>
                  <p>Use Keyword Search to find specific data within BlackBerry backup structures.</p>
                </CardContent>
              </Card>
            </div>
          </TabsContent>
